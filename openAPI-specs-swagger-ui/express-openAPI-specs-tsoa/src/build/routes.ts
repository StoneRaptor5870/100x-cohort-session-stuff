...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/todo',
            ...(fetchMiddlewares<RequestHandler>(TodoController)),
            ...(fetchMiddlewares<RequestHandler>(TodoController.prototype.createUser)),

            async function TodoController_createUser(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
